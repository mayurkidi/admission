    ...
    <div class="kode_wrapper mt-3">
        ...
        <section class="d-flex align-items-center mmdu-img" id="hero">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-between pt-lg-0" data-aos="fade-up" data-aos-delay="200"></div>
                                                    ...
                                                    <div class="form-custom">
                                                        ...
                                                        <div class="form-group label-floating reg_name_div">
                                                            <div class="input text"><label class="control-label widget_label" for="mobilenumber">Mobile Number <span class="required">*</span></label>
                                                                <input type="number" name="mobile" id="mobile" autocomplete="off" class="form-control widget_input" placeholder="Enter Mobile Number *" value="{{ old('mobile') }}">
                                        ...
                                        <div class="tab-pane fade" id="tab2default">
                                            <div id="login_form_without_popup">
                                                <form method="POST" action="{{ route('login') }}">
                                                    @csrf
                                                    <div class="form-group label-floating"><label class="control-label" for="loginEmail">{{ __('Email Address') }} <span class="required">*</span></label><input type="text" name="email" id="loginEmail" maxlength="50" class="placeholder form-control @error('email') is-invalid @enderror" autocomplete="off" value="{{ old('email') }}">
                                                        @if ($errors->has('email'))
                                                        <span class="text-danger">{{ $errors->first('email') }}</span>
                                                        @endif
                                                        <span class="help-block"></span>
                                                    </div>
                                                    <div class="form-group label-floating"><label class="control-label" for="loginPassword">{{ __('Password') }}<span class="required">*</span></label><input type="password" name="password" id="loginPassword" maxlength="15" class="placeholder form-control @error('password') is-invalid @enderror" autocomplete="off" value="">
                                                        @if ($errors->has('password'))
                                                        <span class="text-danger">{{ $errors->first('password') }}</span>
                                                        @endif
                                                        <span class="help-block"></span>
                                            ...
                                            <div id="forgot_pwd_form_without_popup" style="display: none;">
                                                <form method="post" accept-charset="utf-8" id="forgotForm" action="/">
                                                    ...
                                                    <div class="form-group label-floating"><label class="control-label" for="forgetEmail">Enter Your Registered Email ID <span class="required">*</span></label><input type="email" name="Email" id="forgetEmail" maxlength="50" class="form-control asdfgh"><span class="help-block"></span>
                                                    </div>
                                                    <button type="button" id="forgotBtn" class="btn btn-default btn-npf btn-register">Submit</button>
                                                </form>
                                                <div class="form-group agree-group col-md-12 text-center fpass"><a href="javascript:void(0);" onclick="$('#forgot_pwd_form_without_popup').hide(); $('#login_form_without_popup').fadeIn();$('#ForgotOtpTabContainer').hide();">Login
                                                        Now</a></div>
                                            </div>
