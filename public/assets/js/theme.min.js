            ...
            var a = this,
                ...
                n = setInterval((function() {
                    ...
                    var t = 6e4,
                        ...
                        f = 1 === (p = String(p).length >= 2 ? p : "0" + p) ? "second" : "seconds";
                    a.find(".days").text(d), a.find(".hours").text(h), a.find(".minutes").text(c), a.find(".seconds").text(p), a.find(".days_ref").text(m), a.find(".hours_ref").text(u), a.find(".minutes_ref").text(g), a.find(".seconds_ref").text(f)
                }), 1e3)
        }
